...
const Number = ({ handlers,open,setOpen }) => {
  ...
  return (
    ...
    >
      ...
      <DialogContent sx={{display:'flex', flexDirection:'column' , gap:2,p:4}} >
        {/* <DialogContentText>
      ...
      <DialogActions>
        ...
        <Button  type="submit" variant='contained'  sx={{color:'white',bgcolor:'black', mb:2}} fullWidth>Send OTP</Button>
      </DialogActions>
    </Dialog>
  );
};
